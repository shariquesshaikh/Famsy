...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div id="main" class=" jumbotron container">
      ...
      <h2 class="jumbotron container" style="height:10px;color:black;margin-top:5px;" align="center" >This is SEM-V CHAT Page</h2>
      ...
      <div class="output jumbotron" style="overflow-y:auto; height: 500px; background:grey;">
        ...
        $sql = "SELECT * FROM comps_chat where rollno LIKE '31170__'";
